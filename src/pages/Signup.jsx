        ...
        <div className="h-[90%] overflow-y-auto w-full   ">
            <div className="flex flex-col items-center justify-center  bg-black text-white  ">
                ...
                >
                    ...
                    <h1 className="text-2xl font-bold mb-6 text-center">Sign Up to Spotify</h1>
                    {/* 
                    <button
                    ...
                    <label className="text-sm mb-1  w-90 self-center">
                        Confirm Password
                    </label>
                    <div className="relative self-center">
                        <input
                    ...
                    <div className="border-t border-gray-700 mt-6 pt-6 text-center">
                        <button variant="text" onClick={handleGoToLogin}>Already have an account? Login</button>
                    </div>
                </form>
            </div>
        </div>
